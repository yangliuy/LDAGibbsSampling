...
3. You should have received a copy of the GNU General Public License along with this program; if not, write to the Free Software Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA 02111-1307 USA

4. Author's technical blog : http://blog.csdn.net/
...
5. This is a initial implementation for the Topic Expertise Model which is proposed in the following paper:
    ...
    If you use this model implementation, please cite this paper. Thank you.

6. We will also relase more open source code for topic models in https://github.com/yangliuy.
